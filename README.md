...
The community login (`tests/community-login/community-login.robot`, library `resources/GzCommunity.py`) uses the same
`${client_id}` / `${private_key}` as the other JWT logins and names the partner user inline; no extra variables.
